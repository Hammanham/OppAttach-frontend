...
export default function AdminDashboard() {
  ...
  const [form, setForm] = useState({ title: '', company: '', type: 'internship', description: '', location: '', duration: '', applicationFee: 500, isActive: true })
  ...
  const handleCreateOrUpdate = (e) => {
    ...
    promise
      .then(() => {
        setShowForm(false)
        setEditing(null)
        setForm({ title: '', company: '', type: 'internship', description: '', location: '', duration: '', applicationFee: 500, isActive: true })
      ...
      {tab === 'opportunities' && (
        <>
          <div className={styles.toolbar}>
            <button type="button" className={styles.btnPrimary} onClick={() => { setEditing(null); setForm({ title: '', company: '', type: 'internship', description: '', location: '', duration: '', applicationFee: 500, isActive: true }); setShowForm(true); }}>
              + New opportunity
            </button>
          </div>
          {showForm && (
